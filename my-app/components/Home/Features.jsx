...
export default function Features() {
  return (
    <div className="sm:h-[100rem] h-[75rem] w-full dark:bg-black bg-white  dark:bg-grid-small-white/[0.2] bg-grid-small-black/[0.2] relative flex items-center justify-center">
      <div className="absolute pointer-events-none inset-0 flex items-center justify-center dark:bg-black bg-white [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)]"></div>
      <div className="max-w-[100rem] mx-auto px-2 ">
        <h2 className="text-6xl font-semibold text-white text-center sm:text-black">
          What Wyzebot Can Do
        </h2>
